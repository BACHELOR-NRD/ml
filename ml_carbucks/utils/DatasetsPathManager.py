...
class DatasetsPathManager:
    ...
    CARBUCKS_TRAIN_ALL: ADAPTER_DATASETS = [
        (
    ...
    CARBUCKS_TRAIN_STANDARD: ADAPTER_DATASETS = [
        (
    ...
    CARBUCKS_TEST_STANDARD: ADAPTER_DATASETS = [
        (
